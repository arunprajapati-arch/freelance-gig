      ...
      <div className="flex flex-col items-center justify-center gap-8 h-full ">
        ...
        <div className="md:flex-1 flex flex-col   justify-center w-full md:h-full ">
          <form id="onboard-form" action={formAction} className="flex flex-col lg:flex-row w-full items-center  md:justify-evenly gap-6 ">
            <div className="flex flex-col gap-4 sm:gap-6 w-full max-w-sm ">
              ...
              <div className="group">
                ...
                <input 
                  ...
                  className="w-full px-3 sm:px-4 py-2.5 sm:py-3 border border-rose-900 rounded-full focus:ring-2 focus:ring-rose-900 focus:border-rose-900 outline-none transition-all duration-200 text-rose-950 placeholder-rose-900/50 transform hover:scale-[1.02] focus:scale-[1.02] text-sm sm:text-base"
                  required
                />
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 sm:gap-3 w-full">
                  <label className="flex items-center justify-center border border-rose-900 p-3 px-4 sm:px-6 rounded-full cursor-pointer hover:bg-rose-50 has-[:checked]:bg-rose-900 has-[:checked]:border-rose-900 has-[:checked]:text-white transition-all duration-200 group hover:scale-105 has-[:checked]:scale-105 hover:shadow-md has-[:checked]:shadow-md min-w-0">
                    <input 
                      type="radio" 
                      name="accountType" 
                      value="MANUFACTURER" 
              ...
              {state.message && (
                <div className={`p-3 rounded-lg text-xs sm:text-sm animate-in slide-in-from-top duration-300 ${
                  state.success 
            ...
            <div className="flex flex-col items-center animate-in slide-in-from-right duration-700 delay-300 order-first lg:order-last">
              <div className="w-24 h-24 sm:w-32 sm:h-32 md:w-40 md:h-40 bg-stone-200 rounded-full border-4 border-white shadow-md flex items-center justify-center mb-3 sm:mb-4 overflow-hidden transition-all duration-300 hover:shadow-lg hover:scale-105 group">
              ...
              <label className="relative cursor-pointer group">
                ...
                <span className="inline-flex items-center px-4 sm:px-6 py-2 sm:py-3 border border-stone-300 rounded-lg text-xs sm:text-sm font-medium text-stone-700 bg-white hover:bg-stone-50 focus:outline-none focus:ring-2 focus:ring-rose-900 focus:ring-offset-2 transition-all duration-200 group-hover:scale-105 group-hover:shadow-md group-active:scale-95">
        ...
        <div className="flex w-full justify-end items-end mt-4">
          <Button 
            type="submit"
            form="onboard-form"
            className="bg-rose-900 hover:bg-rose-950 text-white font-medium py-5  rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-rose-900 focus:ring-offset-2 transform hover:scale-105 active:scale-95 hover:shadow-lg text-base"
          >
            Complete Profile
          </Button>
        </div>
